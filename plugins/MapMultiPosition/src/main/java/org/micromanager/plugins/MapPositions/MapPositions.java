...
/**
 * Plugin that maps a list of coordinates to stage coordinates using
 * three reference points, and adds them to the Stage Position List.
 *
 ...
 *
 * @author Lars Kool, 2024
 * @copyright Institut Pierre-Gilles de Gennes, ESPCI, PSL, Paris, France
 */
...
public class MapPositions implements SciJavaPlugin, MenuPlugin {
    ...
    public String getHelpText() {
        return "Plugin that maps a list of coordinates to stage coordinates using\n" +
                "three reference points, and adds them to the Stage Position List.";
    }
